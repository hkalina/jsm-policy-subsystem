 ...
 */
public class JsmPolicyService implements Service<JsmPolicyService> {
    ...
    public JsmPolicyService(String suffix, long tick) {
        this.suffix = suffix;
        this.tick.set(tick);
    }

    @Override
    public JsmPolicyService getValue() throws IllegalStateException, IllegalArgumentException {
        return this;
    }
